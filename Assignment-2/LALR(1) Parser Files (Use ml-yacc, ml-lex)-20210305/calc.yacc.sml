...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | START of unit ->  (string option) | EXP of unit ->  (int)
end
...
MlyValue.EXP (fn _ => let val  EXP1 = EXP1 ()
 val  EXP2 = EXP2 ()
 in (AST.expToString(AST.BinApp(AST.Add,EXP1,EXP2)))
end)
...
MlyValue.EXP (fn _ => let val  EXP1 = EXP1 ()
 val  EXP2 = EXP2 ()
 in (AST.expToString(AST.BinApp(AST.Sub,EXP1,EXP2)))
end)
 in ( LrTable.NT 0, ( result, EXP1left, EXP2right), rest671)
end
...
MlyValue.EXP (fn _ => let val  EXP1 = EXP1 ()
 val  EXP2 = EXP2 ()
 in (AST.expToString(AST.BinApp(AST.Mul,EXP1,EXP2)))
end)
 in ( LrTable.NT 0, ( result, EXP1left, EXP2right), rest671)
end
...
MlyValue.EXP (fn _ => let val  EXP1 = EXP1 ()
 val  EXP2 = EXP2 ()
 in (AST.expToString(AST.BinApp(AST.Div,EXP1,EXP2)))
end)
 in ( LrTable.NT 0, ( result, EXP1left, EXP2right), rest671)
end
